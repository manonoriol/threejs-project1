...
pointLight2.position.set(1,6,3)
...
const pointLight3 = new THREE.PointLight(0x2725aa, 2)
pointLight3.position.set(-3.3,6,3)
 ...
 */
 ...
 const windowHalfX = innerWidth / 2;
 const windowHalfY = innerHeight / 2;
